// Dictionary for controlling the main content image, title, and description
var dict = {
    ...
    "2": ["assets/yuuka.webp", "https://github.com/Tsunderarislime/yuuka", "Yuuka", `This is a Discord bot which was a proof of concept for a highly configurable, 
        automated moderation tool. Its main goal was to automatically identify and ban scam advertisement messages. <br><br> 
        ...
        This cog implementation expanded upon the functionality and customizablity of Yuuka. If your server uses the Red Discord Bot or any fork of it, 
        then you can try my cog out by installing <a href='https://github.com/SFUAnime/lui-cogs-v3'>lui-cogs.</a>`],
    "3": ["assets/perona-malik.webp", "https://github.com/Tsunderarislime/perona-malik-edge-enhancement", "Perona-Malik Edge Enhancement", `This is my Python implementation of 
        ...
        for a numerical analysis project.<br><br> I have also built a simple <a href='https://github.com/Tsunderarislime/perona-malik-web'>Flask web application</a> 
